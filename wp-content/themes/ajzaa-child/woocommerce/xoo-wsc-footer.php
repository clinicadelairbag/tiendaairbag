...
$shipping_txt 		= isset($options['sc-shipping-text']) ? $options['sc-shipping-text']: __("Para conocer el costo de envío, proceda al pago.",'side-cart-woocommerce'); // Shipping Text
$cart_txt 			= isset($options['sc-cart-text']) ? $options['sc-cart-text'] : __("Ver carrito",'side-cart-woocommerce'); //Cart Text
$chk_txt 			= isset($options['sc-checkout-text']) ? $options['sc-checkout-text']: __("Pagar",'side-cart-woocommerce'); //Checkout Text
$cont_txt 			= isset($options['sc-continue-text']) ? $options['sc-continue-text'] :__( "Seguir comprando",'side-cart-woocommerce'); //Continue Text
