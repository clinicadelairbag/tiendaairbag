<?php
$ajzaa_footer_style = ajzaa_get_option('ajzaa_footer_style');
                ...
                <ul class="inline-list">
                    <li class="brands">
                        <select name="marques" id="modal_marques">
                            <option value='-1' disabled selected><span>1</span> | <?php echo esc_html__('seleccionar Marca...','ajzaa') ?></option>
                            <?php
                    ...
                    <li class="keyword">
                        <select id="modal_models">
                            <option value='-1' disabled selected>2 <span> |</span> <?php echo esc_html__('seleccionar Modelo...','ajzaa') ?></option>
                        </select>
                    </li>
                    <li class="year">
                        <select id="modal_year">
                            <option value='-1' disabled selected>3 |<?php echo esc_html__('seleccionar Año...','ajzaa') ?> </option>
                        </select>
                    </li>
                    <li class="search">
                        <input type="button" class="button models-btn-submit" value="<?php echo  esc_html__('Buscar', 'ajzaa')  ?>">
                    </li>
                </ul>
            </form>
        </div>
