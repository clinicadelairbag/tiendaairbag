                ...
                <ul class="title-area large-3 medium-3 columns">
                    <li class="name">
                        <div class="wd-logo left">
                            ...
                            if($ajzaa_logo_path != "") { ?>
                                <h1><a title="<?php esc_html_e('Home', 'ajzaa'); ?>" rel="home"
                                       href="<?php echo esc_url(home_url('/')); ?>">
                                        <img alt="<?php echo get_bloginfo(); ?>" src="<?php echo esc_attr($ajzaa_logo_path); ?>"></a>
                                </h1>
                                <?php
                            }
                            else {
                ...
                <div class="large-9 medium-9 columns menu_bar">
                    <div class="header-list">
                        <ul>
                            ...
                            ?>
                            <li class="my_account">
                                <a href="#" data-dropdown="account" data-options="is_hover:true; hover_timeout:500"><?php echo esc_html__('Mi cuenta', 'ajzaa') ?></a>
                                    ...
                                    <div class="header-account-dd header-dd-h js-account-dd-holder"><div class="header-account-top js-my-acc-name-info">
                                        ...
                                        <div class="header-account-text-wrap">
                                            <?php if(is_user_logged_in()) {
                                                ...
                                                ?>
                                                <a class="sign-in" href="<?php echo esc_url( wp_logout_url()) ?>"><?php echo esc_html__('Salir', 'ajzaa'); ?></a>
                                                <?php
                                            }
                                            else {
                                                ?>
                                                <a class="sign-in" href="<?php echo esc_url( wp_login_url()) ?>"><?php echo esc_html__('Entrar', 'ajzaa'); ?></a>
                                                <div class="header-sign-up">
                                                    <span><?php echo esc_html__('Nuevo Cliente?', 'ajzaa'); ?>&nbsp;</span>
                                                    <a class="link" href="<?php echo esc_url(wp_registration_url()) ?>"><?php echo esc_html__('Registrarse', 'ajzaa'); ?></a>
                                                </div>
                                                <?php
                                            } ?>
                                        </div>
                                        <div class="header-left-menu-spacing-wrap">
                                            <ul class="marked-list-h -top-space">
                                                <li class="marked-list-h-item ">
                                                    ...
                                                    <a class="marked-list-h-link -my-account" href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>"><?php echo esc_html__('Cuenta', 'ajzaa'); ?></a>
                                                </li>
                                                <li class="marked-list-h-item ">
                                                    <i class="fa fa-check" aria-hidden="true"></i>
                                                    <a class="marked-list-h-link -my-orders js-my-acc-link" href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>"><?php echo esc_html__('Ordenes', 'ajzaa'); ?></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
