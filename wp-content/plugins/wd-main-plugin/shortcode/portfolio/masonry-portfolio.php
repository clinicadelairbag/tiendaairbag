<ul class="wd-portfolio-masonry <?php echo esc_attr($ajzaa_portfolio_hover_style); ?> large-block-grid-<?php echo esc_attr($ajzaa_portfolio_columns_desktop); ?> medium-block-grid-<?php echo esc_attr($ajzaa_portfolio_columns_tablet); ?> small-block-grid-<?php echo esc_attr($ajzaa_portfolio_columns_mobile); ?>" data-padding="<?php echo esc_attr($padding_items) ?>">
    <?php 
    ...
    while ($wp_query->have_posts()) : $wp_query->the_post();  ?>
      <li class="wd-portfolio-masonry-item
      <?php
      ...
      ">
            ...
            switch ($ajzaa_portfolio_hover_style) {
              case 'style-1':
                ...
                <div class="wd-portfolio-masonry-item-image">
                  <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
                    <?php $thumb = get_post_thumbnail_id(); $img_url = wp_get_attachment_url( $thumb,'full' ); $image = ajzaa_resize( $img_url, 584, true ); ?>
              ...
              <?php
                ...
                <?php $thumb = get_post_thumbnail_id(); $img_url = wp_get_attachment_url( $thumb,'full' ); $image = ajzaa_resize( $img_url, 584, true ); ?>
                <img src="<?php echo esc_attr($image) ?>" alt="<?php the_title(); ?>"/>
                <div class="overlay-color" data-overlaycolor="<?php echo esc_attr($overlay_color) ?>" style="width: calc(100% - <?php echo esc_attr($overlay_width); ?>px);bottom: <?php echo esc_attr($padding_items); ?>px;">
                  <div class="wd-portfolio-masonry-item-text-container">
                    <div class="large-12">
